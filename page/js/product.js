...
async function loadProducts() {
    try {
        const response = await fetch('https://fullstackapi-two.vercel.app/products/');
...
function displayProducts(products) {
    ...
    products.forEach(product => {
        ...
        if (shouldShow) {
            visibleCount++;
            const imageUrl = product.image.startsWith('data:image') ? product.image : `https://fullstackapi-two.vercel.app/images/products/${product.image}`;
